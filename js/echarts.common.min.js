! function(t, e) {
	...
	function d(t, e, n) {
		if (t && e)
			if (t.forEach && t.forEach === np) t.forEach(e, n);
	...
	function Rt(t, e, n, i, r) {
		var o = t.length;
		if (1 == r)
			for (s = 0; s < o; s++) i[s] = Et(t[s], e[s], n);
		else
			for (var a = o && t[0].length, s = 0; s < o; s++)
				for (var l = 0; l < a; l++) i[s][l] = Et(t[s][l], e[s][l], n)
	}
	...
	function Bt(t, e, n) {
		...
		if (i !== r)
			if (i > r) t.length = r;
				...
				for (a = i; a < r; a++) t.push(1 === n ? e[a] : Gp.call(e[a]));
	...
	function Ft(t, e, n, i, r, o, a, s, l) {
		var h = t.length;
		if (1 == l)
			for (c = 0; c < h; c++) s[c] = Ht(t[c], e[c], n[c], i[c], r, o, a);
		else
			for (var u = t[0].length, c = 0; c < h; c++)
				for (var d = 0; d < u; d++) s[c][d] = Ht(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
	}
			...
			if (o || !x) {
				...
				var O = new ft({
					...
					onframe: function(t, e) {
						...
						if (0 !== i)
							if (I = (e - m[n]) / i, l)
								if (C = v[n], T = v[0 === n ? n : n - 1], D = v[n > h - 2 ? h - 1 : n + 1], A = v[n > h - 3 ? h - 1 : n + 2], d) Ft(T, C, D, A, I, I * I, I * I * I, a(t, r), g);
								else {
									if (f) o = Ft(T, C, D, A, I, I * I, I * I * I, L, 1), o = Wt(L);
									else {
						...
						else if (d) Rt(v[n], v[n + 1], I, a(t, r), g);
						else {
							var o;
							if (f) Rt(v[n], v[n + 1], I, L, 1), o = Wt(L);
							else {
	...
	function Jt(t, e) {
		...
		o = [], a = [], this.mergeRuns = function() {
			for (; l > 1;) {
				var t = l - 2;
				if (t >= 1 && a[t - 1] <= a[t] + a[t + 1] || t >= 2 && a[t - 2] <= a[t] + a[t - 1]) a[t - 1] < a[t + 1] && t--;
	...
	function de(t, e, n, i, r, o) {
		...
		r && (s += r[1] + r[3]);
		var l = a.outerHeight,
			h = new Xt(pe(0, s, n), ge(0, l, i), s, l);
	...
	function Se(t, e, n, i) {
		...
		if (n && (s += n[0] + n[2]), t && i) {
			...
			if (null != l && s > l) t = "", o = [];
				...
				for (var u = ye(h - (n ? n[1] + n[3] : 0), e, i.ellipsis, {
						minChar: i.minChar,
	...
	function Me(t, e) {
		...
		for (k = 0; k < a.length; k++) {
			for (var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
				var y = (P = p.tokens[v]).styleName && e.rich[P.styleName] || {},
					x = P.textPadding = y.textPadding,
					_ = P.font = y.font || e.font,
					w = P.textHeight = C(y.textHeight, we(_));
				...
				var b = y.textWidth,
					S = null == b || "auto" === b;
				if ("string" == typeof b && "%" === b.charAt(b.length - 1)) P.percentWidth = b, h.push(P), b = 0;
				else {
					if (S) {
						b = P.textWidth;
					...
					null != A && A < b && (!S || A < T ? (P.text = "", P.textWidth = b = 0) : (P.text = ve(P.text, A - T, _, c.ellipsis, {
						minChar: c.minChar
					}), P.textWidth = ue(P.text, _), b = P.textWidth + T))
				}
	...
	function Ee(t, e, n, i, r, o, a, s) {
		...
		var d = He(l.textStroke || i.textStroke, p),
	...
	function Ve(t, e, n) {
		...
		if (n) {
			...
			if (s instanceof Array) i = n.x + We(s[0], n.width), r = n.y + We(s[1], n.height);
			else {
	...
	function Mn(t) {
		...
		Zg(t, function(t, n) {
			...
			var i = t.exist,
				...
				o = t.keyInfo;
			if (Ug(r)) {
				if (o.name = null != r.name ? r.name + "" : i ? i.name : jg + n, i) o.id = i.id;
	...
	function Zn(t, e, n, i, r, o) {
		var a = i + 3 * (e - n) - t,
			...
			d = l * l - 3 * s * h,
			f = 0;
		if (Fn(u) && Fn(c)) Fn(s) ? o[0] = 0 : (M = -l / s) >= 0 && M <= 1 && (o[f++] = M);
		else {
			var p = c * c - 4 * u * d;
			if (Fn(p)) {
				var g = c / u,
				...
				var _ = (2 * u * s - 3 * a * c) / (2 * om(u * u * u)),
					w = Math.acos(_) / 3,
					b = om(u),
					S = Math.cos(w),
					M = (-s - 2 * b * S) / (3 * a),
					m = (-s + b * (S + lm * Math.sin(w))) / (3 * a),
	...
	function Un(t, e, n, i, r) {
		var o = 6 * n - 12 * e + 6 * t,
			...
			s = 3 * e - 3 * t,
			l = 0;
		if (Fn(a)) Hn(o) && (c = -s / o) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var h = o * o - 4 * a * s;
			if (Fn(h)) r[0] = -o / (2 * a);
			else if (h > 0) {
	...
	function $n(t, e, n, i, r) {
		var o = t - 2 * e + n,
			...
			s = t - i,
			l = 0;
		if (Fn(o)) Hn(a) && (c = -s / a) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var h = a * a - 4 * o * s;
			if (Fn(h))(c = -a / (2 * o)) >= 0 && c <= 1 && (r[l++] = c);
			else if (h > 0) {
				var u = om(h),
					c = (-a + u) / (2 * o),
					d = (-a - u) / (2 * o);
	...
	function _i(t, e, n, i, r, o, a, s, l, h, u) {
		var c = l * (ev / 180),
			d = tv(c) * (t - n) / 2 + Jm(c) * (e - i) / 2,
			f = -1 * Jm(c) * (t - n) / 2 + tv(c) * (e - i) / 2,
			p = d * d / (a * a) + f * f / (s * s);
		p > 1 && (a *= Qm(p), s *= Qm(p));
		var g = (r === o ? -1 : 1) * Qm((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (d * d))) || 0,
			m = g * a * f / s,
			v = g * -s * d / a,
			y = (t + n) / 2 + tv(c) * m - Jm(c) * v,
			x = (e + i) / 2 + Jm(c) * m + tv(c) * v,
			_ = rv([1, 0], [(d - m) / a, (f - v) / s]),
			w = [(d - m) / a, (f - v) / s],
			b = [(-1 * d - m) / a, (-1 * f - v) / s],
			S = rv(w, b);
	...
	function Fi(t) {
		if (!t.__isHover) {
			if (Vi(t), t.useHoverLayer) t.__zr && t.__zr.addHover(t, t.__hoverStl);
			else {
				var e = t.style,
	...
	function Wr(t, e, n, i, r) {
		...
		if (o || s) {
			var h;
			if ("raw" === l) h = "group" === t.type ? new Xt(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
	...
	function eo(t, e, n, i, r) {
		...
		if (e === oy) "auto" === i || null == i ? io(function(t) {
			...
			r[e] = null != t ? t : ""
		}, n, t)), o = r ? r.length : n === cy ? t.length : t[0] ? t[0].length : null;
		else if (e === ay) r || (r = ro(t), s = !0);
		else if (e === sy) r || (r = [], s = !0, d(t, function(t, e) {
			r.push(e)
		}));
		else if (e === ry) {
			var l = wn(t[0]);
	...
	function io(t, e, n, i) {
		if (null == i && (i = 1 / 0), e === cy)
			for (o = 0; o < n.length && o < i; o++) t(n[o] ? n[o][0] : null, o);
		else
			for (var r = n[0] || [], o = 0; o < r.length && o < i; o++) t(r[o], o)
	}
		...
		if (a && null != f.get(u)) {
			...
			d(a.coordSysDims, function(t) {
				if (null == a.firstCategoryDimIndex) {
					e = v.valueWayDim++;
					s[t] = e, h.push(e)
				} else if (a.categoryAxisMap.get(t)) s[t] = 0, l.push(0);
				else {
	...
	function lo(t, e, n, i, r, o) {
		...
		if (S(t)) return !1;
		var l;
		if (i && (l = w(l = i[o]) ? l.name : l), e === oy)
			if (n === cy) {
				for (var h = t[o], u = 0; u < (h || []).length && u < 5; u++)
					if (null != (s = a(h[r + u]))) return s
			} else
				for (u = 0; u < t.length && u < 5; u++) {
					...
					if (!l) return;
					for (u = 0; u < t.length && u < 5; u++)
						if ((d = t[u]) && null != (s = a(d[l]))) return s
				} else if (e === sy) {
			if (!l) return;
			if (!(h = t[l]) || S(h)) return !1;
			for (u = 0; u < h.length && u < 5; u++)
				if (null != (s = a(h[u]))) return s
		} else if (e === ry)
			for (u = 0; u < t.length && u < 5; u++) {
				var d = t[u],
					f = wn(d);
	...
	function co(t) {
		t = t, this.option = {}, this.option[fy] = 1, this._componentsMap = N({
			series: []
		}), this._seriesIndices, this._seriesIndicesMap, uo(t, this._theme.option), i(t, ty, !1), this.mergeOption(t)
	}
	...
	function ko(t) {
		if (Sy(t)) {
			...
			if ("graph" === t.type) {
				...
				if (o && !S(o))
					for (s = 0; s < o.length; s++) Ao(o[s]);
				d(t.categories, function(t) {
					Co(t)
				})
			}
			if (r && !S(r))
				for (s = 0; s < r.length; s++) Ao(r[s]);
			if ((e = t.markPoint) && e.data)
				for (var a = e.data, s = 0; s < a.length; s++) Ao(a[s]);
			if ((n = t.markLine) && n.data)
				for (var l = n.data, s = 0; s < l.length; s++) y(l[s]) ? (Ao(l[s][0]), Ao(l[s][1])) : Ao(l[s]);
	...
	function Zo(t, e, n) {
		if (t) {
			...
			if (null != i) {
				var r, o, a = t.getProvider().getSource().sourceFormat,
	...
	function ra(t, e) {
		if (t && (t.trigger(e), "group" === t.type))
			for (var n = 0; n < t.childCount(); n++) ra(t.childAt(n), e)
	}
	...
	function sa(t) {
		var e = t.model,
			...
			i = t.api,
			r = t.payload,
			o = e.pipelineContext.canProgressiveRender,
			a = t.view,
			s = r && Hy(r).updateMethod,
	...
	function pa(t, e, n, i, r) {
		function o(e) {
			...
			i.context = {
				...
				overallProgress: u,
				isOverallFilter: c
			}, i.agent = a, i.__block = u, Sa(t, e, i)
		}
		var a = n.overallTask = n.overallTask || Xo({
			reset: ga
		});
		a.context = {
			ecModel: i,
	...
	function wa(t, e) {
		for (var n = e.data, i = e.resetDefines, r = 0; r < i.length; r++) {
			var o = i[r];
			if (o && o.dataEach)
				for (var a = t.start; a < t.end; a++) o.dataEach(n, a);
			else o && o.progress && o.progress(t, n)
		}
	}
	...
	function bs(t, e) {
		var n = t.dimensions,
			i = new Yx(f(n, t.getDimensionInfo, t), t.hostModel);
		ms(i, t);
	...
	function Hs(t, e, n, i) {
		...
		if (!t) return r;
		e[0] < n[0] && r.push(e[0]);
		for (var o = n[0]; o <= n[1] && (r.push(o), (o = e_(o + t, i)) !== r[r.length - 1]);)
	...
	function Ys(t, e, n, i) {
		var r = n.axis.getExtent(),
			o = r[1] - r[0],
			a = Zs(i)[n.axis.dim + n.axis.index];
		if (void 0 === a) return {
			min: t,
			max: e
		};
	...
	function ol(t) {
		...
		for (var n = t.features, i = 0; i < n.length; i++)
			for (var r = n[i].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0; s < o.length; s++) {
				var l = o[s];
				if ("Polygon" === r.type) o[s] = al(l, a[s], e);
	...
	function Il(t, e, n, i, r, o, a, s, l, h, u) {
		for (var c = 0, d = n, f = 0; f < i; f++) {
			...
			if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), j_(q_, p);
			else if (l > 0) {
				var g = d + o,
					m = e[g];
				if (u)
					for (; m && wl(e[g]);) m = e[g += o];
				var v = .5,
					y = e[c];
				if (!(m = e[g]) || wl(m)) j_($_, p);
				else {
					wl(m) && !u && (m = p), W(Y_, m, y);
					var x, _;
					if ("x" === h || "y" === h) {
	...
	function Pl(t, e, n) {
		...
		return e && (d.shape[o ? "width" : "height"] = 0, sr(d, {
			shape: {
				width: l,
				height: h
			}
	...
	function Ll(t, e, n) {
		...
		return e && (s.shape.endAngle = -o[0] * a, sr(s, {
			shape: {
				endAngle: -o[1] * a
			}
		}, n)), s
	...
	function eh(t, e, n) {
		...
		if (e.get("axisTick.show") && !i.scale.isBlank()) {
			for (var r = e.getModel("axisTick"), o = r.getModel("lineStyle"), s = r.get("length"), l = ww(r, n.labelInterval), h = i.getTicksCoords(r.get("alignWithLabel")), u = i.scale.getTicks(), c = e.get("axisLabel.showMinLabel"), d = e.get("axisLabel.showMaxLabel"), f = [], p = [], g = t._transform, m = [], v = h.length, y = 0; y < v; y++)
				if (!_w(i, y, l, v, c, d)) {
					var x = h[y];
	...
	function nh(t, e, n) {
		...
		if (T(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
			var r = e.getModel("axisLabel"),
				...
				l = (T(n.labelRotate, r.get("rotate")) || 0) * mw / 180,
				h = xw(n.rotation, l, n.labelDirection),
				u = e.getCategories(),
				c = [],
				f = $l(e),
		...
		bw(n.getCoordinateSystems(), function(n) {
			function s(i, s, l) {
				...
				if (d && ("auto" !== d || i || dh(c))) {
					...
					var f = (c = i ? oh(l, u, r, e, i, s) : c).get("snap"),
						p = fh(l.model),
	...
	function wh(t, e, n, i, r, o, s, l) {
		...
		l || t.setShape("r", c.get("barBorderRadius") || 0), t.useStyle(a({
			fill: h,
			opacity: u
		}, c.getBarItemStyle()));
	...
	function Th(t, e, n, i, r, o, a) {
		...
		for (var h, u = 0, c = t.length, d = [], f = [], p = 0; p < c; p++)(h = t[p].y - u) < 0 && function(e, n, i, r) {
			for (var o = e; o < n; o++)
				if (t[o].y += i, o > e && o + 1 < n && t[o + 1].y > t[o].y + t[o].height) return void s(o, i / 2);
			s(n - 1, i / 2)
	...
	function Ah(t, e, n, i) {
		var r = n.type,
			o = new(0, Av[r.charAt(0).toUpperCase() + r.slice(1)])(n);
	...
	function zh(t, e, n) {
		var r = o({}, n),
			a = t[e],
			s = n.$action || "merge";
		"merge" === s ? a ? (i(a, r, !0), Zr(a, r, {
			ignoreSize: !0
		}), Xr(n, a)) : t[e] = r : "replace" === s ? t[e] = r : "remove" === s && a && (t[e] = null)
	}
	...
	function Gh(t, e, n) {
		var i = n.getZr(),
			r = qw(i).axisPointerLastHighlights || {},
			o = qw(i).axisPointerLastHighlights = {};
		jw(t, function(t, e) {
	...
	function Nu(t, e, n, i, r, o) {
		var a = [],
			s = As(e, i, n) ? e.getCalculationInfo("stackResultDimension") : i,
			l = Gu(e, s, t),
	...
	function Ru(t, e) {
		...
		if (e && !Eu(e) && !y(e.coord) && r) {
			...
			if ((e = n(e)).type && Tb[e.type] && a.baseAxis && a.valueAxis) {
				var s = Mb(o, a.baseAxis.dim),
					l = Mb(o, a.valueAxis.dim);
	...
	function Wu(t, e, n) {
		...
		t.each(function(r) {
			var o, a = t.getItemModel(r),
				s = _r(a.get("x"), n.getWidth()),
				l = _r(a.get("y"), n.getHeight());
			if (isNaN(s) || isNaN(l)) {
				if (e.getMarkerPosition) o = e.getMarkerPosition(t.getValues(t.dimensions, r));
				else if (i) {
	...
	function ed(t) {
		...
		return d(t, function(t, n) {
			var i = t.categoryAxis,
				r = t.valueAxis.dim,
				o = [" "].concat(f(t.series, function(t) {
					return t.name
				})),
	...
	function ud(t, e) {
		return f(t, function(t, n) {
			var i = e && e[n];
			return w(i) && !y(i) ? (w(t) && !y(t) && (t = t.value), a({
				value: t
			}, i)) : t
		})
	}
	...
	function zd(t, e, n, i, r, o, a, s) {
		...
		_S(r.split(""), function(t) {
			var e = AS[t];
			h[e[0]][e[1]] += u[e[0]]
		}), l.range = e(Pd(h[0][0], h[1][0], h[0][1], h[1][1])), yd(n, i), Sd(n, {
			isEnd: !1
		})
	}
	...
	function Bd(t) {
		var e = bS(t[0][0], t[1][0]),
			n = bS(t[0][1], t[1][1]);
		return {
			x: e,
			y: n,
			width: SS(t[0][0], t[1][0]) - e,
			height: SS(t[0][1], t[1][1]) - n
		}
	}
	...
	function Gd(t, e, i, r) {
		...
		if (t._track.push(i.slice()), Md(t) || a) {
			...
			if (a) {
				...
				a.__brushOption.range = u.getCreatingRange(Rd(t, a, t._track)), r && (gd(t, a), u.updateCommon(t, a)), md(t, a), o = {
					isEnd: r
				}
			}
	...
	function Ud(t) {
		return {
			...
			updateCoverShape: function(e, n, i, r) {
				var o, a = wd(e, n);
				if (!0 !== a && a.getLinearBrushOtherExtent) o = a.getLinearBrushOtherExtent(t, e._transform);
				else {
					var s = e._zr;
	...
	var cp = (Object.freeze || Object)({
		...
		dp = "undefined" == typeof Float32Array ? Array : Float32Array,
		fp = Z,
		pp = U,
		gp = Y,
		mp = q,
	...
	var Sp = "undefined" == typeof Float32Array ? Array : Float32Array,
		...
		_animateToShallow: function(t, e, n, i, r) {
			...
			for (var s in n)
				if (n.hasOwnProperty(s))
					if (null != e[s]) w(n[s]) && !c(n[s]) ? this._animateToShallow(t ? t + "." + s : s, e[s], n[s], i, r) : (o[s] = n[s], a++);
					else if (null != n[s])
				if (t) {
					var l = {};
		...
		applyTransform: function() {
			...
			return function(r) {
				if (r) {
					...
					var o = Qp(t[0], e[0], n[0], i[0]),
						a = Qp(t[1], e[1], n[1], i[1]);
	...
	Tg.prototype = {
		...
		insertLayer: function(t, e) {
			var n = this._layers,
				...
				a = -1,
				s = this._domRoot;
			if (n[t]) jp("ZLevel " + t + " has been used already");
			else if (qe(e)) {
				if (r > 0 && t > i[0]) {
	...
	var Cg = "undefined" != typeof window && !!window.addEventListener,
		Dg = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
		Ag = Cg ? function(t) {
		...
		kg = function(t) {
			t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, xp.call(this)
		};
	kg.prototype = {
		constructor: kg,
		addClip: function(t) {
	...
	var Vg = !Kf.canvasSupported,
		...
		Gg = function(t, e, n) {
			...
			this.handler = new bp(r, a, s, a.root), this.animation = new kg({
				stage: {
	...
	var Wg = (Object.freeze || Object)({
		...
		qg = 0,
		$g = ".",
		Kg = "___EC__COMPONENT__CONTAINER___",
		Qg = 0,
		Jg = function(t) {
		...
		Lm = Math.sqrt,
		Om = Math.abs,
		zm = "undefined" != typeof Float32Array,
		Em = function(t) {
	...
	var Nm = 2 * Math.PI,
		...
		Hm = [-1, -1, -1],
		Gm = [-1, -1],
		Wm = ug.prototype.getCanvasPattern,
		Zm = Math.abs,
		Um = new Em(!0);
	xi.prototype = {
		constructor: xi,
			...
			for (r = 0, o = 0; r < l.length;) {
				switch (n = l[r++], o = r, i = 0, n) {
					...
					case f:
						var g = e[4],
							m = e[5],
							v = Ym(e[0] * e[0] + e[1] * e[1]),
							y = Ym(e[2] * e[2] + e[3] * e[3]),
							x = qm(-e[1] / y, e[0] / v);
		...
		lv = function(t) {
			return Kf.browser.ie && Kf.browser.version >= 11 ? function() {
				...
				if (t.apply(this, arguments), e)
					for (var l = 0; l < sv.length; l++) i[sv[l][0]] = sv[l][2]
			} : t
		},
		hv = xi.extend({
			type: "sector",
	...
	Sv.prototype = {
		constructor: Sv
	}, h(Sv, wv), Di.prototype.incremental = !0, Di.prototype.clearDisplaybles = function() {
	...
	var Nv = 0,
		...
		Xv = d,
		jv = ["left", "right", "top", "bottom", "width", "height"],
		Yv = [
			["width", "left", "right"],
			["height", "top", "bottom"]
		],
				...
				Jr(this), d(t, function(t, r) {
					...
					e[n] = [], r.set(n, []), d(s, function(t, i) {
						...
						if (P(w(s) || a, "Empty component definition"), s) {
							...
							if (a && a instanceof h) a.name = t.keyInfo.name, a.mergeOption(s, this), a.optionUpdated(s, !1);
							else {
								var u = o({
									dependentModels: l,
									componentIndex: i
	...
	var by = d,
		Sy = w,
		My = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
		Iy = function(t, e) {
	...
	Ey.perform = function(t) {
		...
		if (this._dueEnd = e ? e._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			var s = this._dueIndex,
				l = Math.min(null != a ? this._dueIndex + a : 1 / 0, this._dueEnd);
			!n && (o || s < l) && this._progress({
				start: s,
				end: l
		...
		Ry = Qv.extend({
			...
			init: function(t, e, n, i) {
				this.seriesIndex = this.componentIndex, this.dataTask = Xo({
					...
					model: this
				}, this.mergeDefaultAndTheme(t, n), to(this);
			...
			fillDataTextStyle: function(t) {
				if (t)
					for (var e = ["show"], n = 0; n < t.length; n++) t[n] && t[n].label && _n(t[n], "label", e)
			},
			...
			formatTooltip: function(t, e, n) {
				...
				var r = this.getData(),
					o = r.mapDimension("defaultedTooltip", !0),
					a = o.length,
			...
			getColorFromPalette: function(t, e, n) {
				var i = this.ecModel,
					r = ny.getColorFromPalette.call(this, t, e, n);
	...
	var Vy = By.prototype;
	Vy.updateView = Vy.updateLayout = Vy.updateVisual = function(t, e, n, i) {}, En(By), Vn(By, {
		registerWhenExtend: !0
	});
	var Fy = function() {
			var t = Dn();
	...
	Wy.updateView = Wy.updateLayout = Wy.updateVisual = function(t, e, n, i) {
		...
		registerWhenExtend: !0
	}), ia.markUpdateMethod = function(t, e) {
		Hy(t).updateMethod = e
	};
	var Zy = {
		...
		$y = function(t, e) {
			...
			if (o.get("show"))
				if (o.get("description")) t.setAttribute("aria-label", o.get("description"));
					...
					var s, l = o.get("data.maxCount") || 10,
					...
					if (!(a < 1)) {
						...
						s += n(i(a > 1 ? "series.multiple.prefix" : "series.single.prefix"), {
							...
							if (e < u) {
								...
								var c = t.getData();
								window.data = c, c.count() > l ? o += n(i("data.partialData"), {
									displayCnt: l
								}) : o += i("data.allData");
	...
	Qy.getPerformArgs = function(t, e) {
		...
		da(this, this._dataProcessorHandlers, t, e, {
			block: !0
		})
	...
	var ix = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
		rx = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], ix
			]
		},
	...
	_x._onframe = function() {
		...
		if (ux(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[vx] = !0, !this._model || e) {
			var r = new xo(this._api),
				o = this._theme,
				a = this._model = new py(null, null, o, r);
			a.scheduler = this._scheduler, a.init(null, null, o, r)
		}
		this._model.setOption(t, Cx), n ? (this[yx] = {
			silent: i
		}, this[vx] = !1) : (ka(this), bx.update.call(this), this._zr.flush(), this[yx] = !1, this[vx] = !1, za.call(this, i), Ea.call(this, i))
	...
	var bx = {
		...
		update: function(t) {
			...
			if (e) {
				...
				if (Kf.canvasSupported) i.setBackgroundColor(a);
				else {
					var s = Mt(a);
		...
		updateView: function(t) {
			var e = this._model;
			e && (ia.markUpdateMethod(t, "updateView"), Ba(e), this._scheduler.performVisualTasks(e, t, {
				setDirty: !0
			}), Va(this, this._model, this._api, t), Ga(e, this._api))
		},
	...
	_x.resize = function(t) {
		...
		ux(e) || (e = {
			silent: !!e
		}), Mx[t.type] && this._model && (this[vx] ? this._pendingActions.push(t) : (Oa.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : !1 !== e.flush && Kf.browser.weChat && this._throttledZrFlush(), za.call(this, e.silent), Ea.call(this, e.silent)))
	...
	var Fx = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		Hx = w,
		Gx = "undefined" == typeof window ? global : window,
		Wx = "e\0\0",
		Zx = {
		...
		Ux = void 0 === Gx.Uint32Array ? Array : Gx.Uint32Array,
		Xx = void 0 === Gx.Uint16Array ? Array : Gx.Uint16Array,
	...
	qx.type = "list", qx.hasItemOption = !0, qx.getDimension = function(t) {
		...
		if (!(t >= e)) {
			...
			for (var _ = t; _ < e; _++) {
				for (var w = r.getItem(_), b = Math.floor(_ / i), S = _ % i, M = 0; M < a.length; M++) {
					var I = a[M],
						T = o[I][b],
						C = this._dimValueGetter(w, I, _, M);
				...
				if (!this._indices) {
					...
					if (1 === i) {
						for (var d = this._storage[e[0]], f = 0; f < this._chunkCount; f++)
							for (var p = d[f], g = Math.min(this._count - f * this._chunkSize, this._chunkSize), m = 0; m < g; m++)(w = p[m]) >= l && w <= h && (o[a++] = c), c++;
						u = !0
					} else if (2 === i) {
		...
		for (var r = bs(this, [t]), o = r._storage, a = [], s = Math.floor(1 / e), l = o[t], h = this.count(), u = this._chunkSize, c = r._rawExtent[t], d = new(ps(this))(h), f = 0, p = 0; p < h; p += s) {
			...
			var x = n(a),
				_ = this.getRawIndex(Math.min(p + i(a, x) || 0, h - 1)),
				w = _ % u;
		...
		if (this._itemVisuals[t] = i, Hx(e))
			for (var o in e) e.hasOwnProperty(o) && (i[o] = e[o], r[o] = !0);
		else i[e] = n, r[e] = !0
	...
	rl.prototype = {
		...
		transformTo: function(t, e, n, i) {
			var r = this.getBoundingRect(),
				o = r.width / r.height;
			n ? i || (i = n / o) : n = o * i;
			for (var a = new Xt(t, e, n, i), s = r.calculateTransform(a), l = this.geometries, h = 0; h < l.length; h++)
				if ("polygon" === l[h].type) {
					for (var u = l[h].exterior, c = l[h].interiors, d = 0; d < u.length; d++) $(u[d], u[d], s);
					for (var f = 0; f < (c ? c.length : 0); f++)
						for (d = 0; d < c[f].length; d++) $(c[f][d], c[f][d], s)
	...
	R_._createSymbol = function(t, e, n, i) {
		...
		r.attr({
			...
			culling: !0,
			scale: ul(i)
		}), r.drift = dl, this._symbolType = t, this.add(r)
		...
		if (a ? this._createSymbol(i, t, e, o) : ((s = this.childAt(0)).silent = !1, ar(s, {
				scale: ul(o)
			}, r, e)), this._updateCommon(t, e, o, n), a) {
			...
			}), s.scale = [0, 0], l && (s.style.opacity = 0), sr(s, h, r, e)
		}
		this._seriesModel = r
	};
	var B_ = ["itemStyle"],
		V_ = ["emphasis", "itemStyle"],
		F_ = ["label"],
		H_ = ["emphasis", "label"];
	...
	G_.updateData = function(t, e) {
		...
		r || n.removeAll(), t.diff(r).add(function(i) {
			...
			var h = r.getItemGraphicEl(l),
				u = t.getItemLayout(s);
			pl(t, u, s, e) ? (h ? (h.updateData(t, s, a), ar(h, {
				position: u
			}, i)) : (h = new o(t, s)).attr("position", u), n.add(h), t.setItemGraphicEl(s, h)) : n.remove(h)
		}).remove(function(t) {
		...
		Q_ = xi.extend({
			...
			buildPath: function(t, e) {
				var n = e.points,
					...
					o = n.length,
					a = e.smoothMonotone,
					s = Tl(n, e.smoothConstraint),
					l = Tl(i, e.smoothConstraint);
				if (e.connectNulls) {
					for (; o > 0 && wl(n[o - 1]); o--);
					for (; r < o && wl(n[r]); r++);
				}
	...
	ia.extend({
		...
		render: function(t, e, n) {
			var i = t.coordinateSystem,
				...
				x = kl(i, o, vl(i, o, y)),
				_ = t.get("showSymbol"),
				w = _ && !u && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(o, i),
				b = this._data;
			...
			if (f && c.type === i.type && S === this._step) {
				...
				var M = Ol(i, !1, t);
				g.setClipPath(M), _ && d.updateData(o, {
					isIgnore: w,
					clipShape: M
				}), o.eachItemGraphicEl(function(t) {
					t.stopAnimation(!0)
				}), Cl(this._stackedOnPoints, x) && Cl(this._points, h) || (m ? this._updateAnimation(o, x, i, n, S, y) : (S && (h = zl(h, i, S), x = zl(x, i, S)), f.setShape({
					points: h
				}), p && p.setShape({
					points: h,
					stackedOnPoints: x
			...
			if (T = Dl(t.get("smooth")), f.setShape({
				...
				var C = o.getCalculationInfo("stackedOnSeries"),
					D = 0;
		...
		_updateAnimation: function(t, e, n, i, r, o) {
			var a = this._polyline,
				s = this._polygon,
				l = t.hostModel,
				h = W_(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o),
				u = h.current,
				c = h.stackedOnCurrent,
				d = h.next,
				f = h.stackedOnNext;
			r && (u = zl(h.current, n, r), c = zl(h.stackedOnCurrent, n, r), d = zl(h.next, n, r), f = zl(h.stackedOnNext, n, r)), a.shape.__points = h.current, a.shape.points = u, ar(a, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
						...
						return As(e, r[0], r[1]) && (r[0] = e.getCalculationInfo("stackResultDimension")), As(e, r[1], r[0]) && (r[1] = e.getCalculationInfo("stackResultDimension")), o && {
							progress: function(t, e) {
								for (var a = t.end - t.start, s = i && new Float32Array(a * o), l = t.start, h = 0, u = [], c = []; l < t.end; l++) {
									var d;
									if (1 === o) f = e.get(r[0], l, !0), d = !isNaN(f) && n.dataToPoint(f, null, c);
									else {
										var f = u[0] = e.get(r[0], l, !0),
											p = u[1] = e.get(r[1], l, !0);
	...
	aw.categoryAxis = i({
		...
		min: "dataMin",
		max: "dataMax"
	}, aw.valueAxis), aw.logAxis = a({
		scale: !0,
		logBase: 10
	}, aw.valueAxis);
	var sw = ["value", "category", "time", "log"],
		lw = function(t, e, n, o) {
			d(sw, function(a) {
				e.extend({
					type: t + "Axis." + a,
		...
		function i(n) {
			return function(i, s) {
				if (Vl(i, t, e)) {
					...
					var h = new rw(n, $s(i), [0, 0], i.get("type"), l),
						u = "category" === h.type;
					...
					if ("number" == typeof u && (u = [u, u]), null != l) {
						...
						d([{
							...
							if ("none" !== l[n] && null != l[n]) {
								var i = el(l[n], -c / 2, -f / 2, c, f, s.stroke, !0),
									o = e.r + e.offset,
	...
	var Tw = vw.ifIgnoreOnTick,
		Cw = vw.getInterval,
		Dw = ["axisLine", "axisTickLabel", "axisName"],
		Aw = ["splitArea", "splitLine"],
		kw = Mw.extend({
			type: "cartesianAxis",
			...
			_splitLine: function(t, e, n) {
				...
				if (!i.scale.isBlank()) {
					var r = t.getModel("splitLine"),
						...
						l = Cw(r, n);
					s = y(s) ? s : [s];
					for (var h = e.coordinateSystem.getRect(), u = i.isHorizontal(), c = 0, d = i.getTicksCoords(), f = i.scale.getTicks(), p = t.get("axisLabel.showMinLabel"), g = t.get("axisLabel.showMaxLabel"), m = [], v = [], x = o.getLineStyle(), _ = 0; _ < d.length; _++)
						if (!Tw(i, _, l, d.length, p, g)) {
			...
			_splitArea: function(t, e, n) {
				...
				if (!i.scale.isBlank()) {
					...
					for (var m = t.get("axisLabel.showMinLabel"), v = t.get("axisLabel.showMaxLabel"), x = 1; x < h.length; x++)
						if (!(Tw(i, x, p, h.length, m, v) && x < h.length - 1)) {
		...
		_render: function(t, e, n) {
			...
			o.diff(a).add(function(e) {
				...
				if (o.hasValue(e)) {
					...
					l ? ar(l, {
						shape: c
					}, h, e) : l = zw[s.type](o, e, u, c, i, h, !0), o.setItemGraphicEl(e, l), r.add(l), wh(l, o, e, u, c, t, i, "polar" === s.type)
				} else r.remove(l)
			}).remove(function(t) {
			...
			cartesian2d: function(t, e, n, i, r, a, s) {
				...
				if (a) {
					var h = l.shape,
						u = r ? "height" : "width",
						c = {};
					h[u] = 0, c[u] = i[u], Av[s ? "updateProps" : "initProps"](l, {
						shape: c
					}, a, e)
				}
				return l
			...
			polar: function(t, e, n, i, r, o, s) {
				...
				if (o) {
					var u = h.shape,
						c = r ? "r" : "endAngle",
						d = {};
					u[c] = r ? 0 : i.startAngle, d[c] = i[c], Av[s ? "updateProps" : "initProps"](h, {
						shape: d
					}, o, e)
				}
				return h
		...
		d(i, function(t) {
			...
			for (var d = e.mapDimension(u.dim), f = e.mapDimension(i.dim), p = As(e, d, f), g = u.isHorizontal(), m = i.onZero || p ? u.toGlobalCoord(u.dataToCoord(0)) : u.getGlobalExtent()[0], v = 0, y = e.count(); v < y; v++) {
				...
				if (!isNaN(x)) {
					...
					var S, M, I, T;
					if (g) S = b, M = (C = n.dataToPoint([x, _]))[1] + l, I = C[0] - m, T = h, Math.abs(I) < c && (I = (I < 0 ? -1 : 1) * c), p && (o[a][_][w] += I);
					else {
	...
	var Nw = function(t, e, n) {
		...
		Bw = as({
			...
			getDataParams: function(t) {
				var e = this.getData(),
					n = Bw.superCall(this, "getDataParams", t),
					i = [];
	...
	Vw.updateData = function(t, e, n) {
		...
		var s = this.childAt(0),
			...
			u = t.getItemLayout(e),
			c = o({}, u);
		c.label = null, n ? (s.setShape(c), "scale" === l.getShallow("animationType") ? (s.shape.r = u.r0, sr(s, {
			shape: {
				r: u.r
			}
		}, l, e)) : (s.shape.endAngle = u.startAngle, ar(s, {
			shape: {
				endAngle: u.endAngle
			}
		}, l, e))) : ar(s, {
	...
	var Fw = function(t, e, n, i) {
			...
			a.each(function(n) {
				...
				var A = p.getFont(),
					k = p.get("rotate") ? _ < 0 ? -x + Math.PI : -x : 0,
		...
		return {
			...
			reset: function(t, e) {
				...
				r.each(function(t) {
					...
					var o = i[e],
						a = null != o && r.getItemVisual(o, "color", !0);
					if (a) n.setItemVisual(e, "color", a);
					else {
	...
	Zw.isPersistent = function() {
		...
		this.group.removeAll(), this._clearIncremental(), t.count() > 2e6 ? (this._incremental || (this._incremental = new Di({
			silent: !0
		...
		updateTransform: function(t, e, n) {
			var i = t.getData();
			if (this.group.dirty(), !this._finished || i.count() > 1e4 || !this._symbolDraw.isPersistent()) return {
				update: !0
			};
			var r = tw().reset(t);
	...
	var Xw = function(t, e) {
			...
			var o = n.getData(),
				a = Cn(o, t);
			if (null == a || a < 0 || y(a)) return {
				point: []
			};
			var s = o.getItemGraphicEl(a),
				l = n.coordinateSystem;
			if (n.getTooltipPosition) i = n.getTooltipPosition(a) || [];
			else if (l && l.dataToPoint) i = l.dataToPoint(o.getValues(f(l.dimensions, function(t) {
	...
	var nb = Jh.extend({
			makeElOption: function(t, e, n, i, r) {
				var o = n.axis,
					a = o.grid,
					s = i.get("type"),
					l = fu(a, o).getOtherAxis(o).getGlobalExtent(),
			...
			updateHandleTransform: function(t, e, n, i) {
				var r = n.axis,
					...
					s = fu(o, r).getOtherAxis(r).getGlobalExtent(),
					l = "x" === r.dim ? 0 : 1,
					h = t.position;
	...
	os({
		...
		_showTooltipContent: function(t, e, n, i, r, o, a, s) {
			if (this._ticket = "", t.get("showContent") && t.get("show")) {
				...
				a = a || t.get("position");
				var u = e;
				if (h && "string" == typeof h) u = Nr(h, n, !0);
		...
		_updateData: function(t) {
			...
			t.eachRawSeries(function(i) {
				...
				if (i.legendDataProvider) {
					var a = i.legendDataProvider(),
						s = a.mapArray(a.getName);
	...
	var mb = cb.extend({
		...
		_b = gb.extend({
			...
			renderInner: function(t, e, n, i) {
				function r(t, n) {
					var r = t + "DataIndex",
						l = fr(e.get("pageIcons", !0)[e.getOrient().name][n], {
							onclick: m(o._pageGo, o, r, e, i)
						}, {
							x: -s[0] / 2,
							y: -s[1] / 2,
							width: s[0],
			...
			layoutInner: function(t, e, n) {
				...
				if ((v = {
					...
					y[s] = Math.max(n[s] - c[s] - m, 0), y[l] = v[l], r.setClipPath(new gv({
						shape: y
					})), r.__rectSize = y[s]
	...
	var Db = mv.prototype,
		...
		kb = Ai({
			...
			tangentAt: function(t) {
				var e = this.shape,
					n = Uu(e) ? [e.x2 - e.x1, e.y2 - e.y1] : Ab.tangentAt.call(this, t);
				return j(n, n)
			}
		}),
		Pb = ["fromSymbol", "toSymbol"],
		Lb = $u.prototype;
	Lb.beforeUpdate = function() {
		...
		if (e || n || !i.ignore) {
			...
			if (this.__dirty || a.__dirty) {
				...
				if (!i.ignore) {
					i.attr("position", h);
					var d, f, p, g = 5 * r;
					if ("end" === i.__position) d = [u[0] * g + h[0], u[1] * g + h[1]], f = u[0] > .8 ? "left" : u[0] < -.8 ? "right" : "center", p = u[1] > .8 ? "top" : u[1] < -.8 ? "bottom" : "middle";
					else if ("middle" === i.__position) {
						var m = s / 2,
							v = [(c = a.tangentAt(m))[1], -c[0]],
							y = a.pointAt(m);
		...
		var i = t.hostModel,
			r = Yu(t.getItemLayout(e));
		r.shape.percent = 0, sr(r, {
			shape: {
				percent: 1
			}
		}, i, e), this.add(r);
		...
		var c = t.getItemVisual(e, "color"),
			f = D(t.getItemVisual(e, "opacity"), o.opacity, 1);
		r.useStyle(a({
			strokeNoScale: !0,
			fill: "none",
			stroke: c,
	...
	var zb = function(t, e, r, a) {
		...
		if (!y(a) && ("min" === l || "max" === l || "average" === l || null != a.xAxis || null != a.yAxis)) {
			var h, u;
			if (null != a.yAxis || null != a.xAxis) h = null != a.yAxis ? "y" : "x", e.getAxis(h), u = T(a.yAxis, a.xAxis);
			else {
				var c = Bu(a, s, e, t);
	...
	Cb.extend({
		...
		renderSeries: function(t, e, n, i) {
			...
			e.setData(u), u.each(function(e) {
				...
				}, e, t), h.group.add(i), u.setItemGraphicEl(t, i)
			}).remove(function(t) {
	...
	var Rb = ["cartesian2d", "polar", "singleAxis"],
		Bb = function(t, e) {
			var n = f(t = t.slice(), Fr),
				i = f(e = (e || []).slice(), Fr);
			return function(r, o) {
				d(t, function(t, a) {
					for (var s = {
	...
	var Gb = d,
		...
		Zb = rs({
			...
			doInit: function(t) {
				var e = this.option;
				Kf.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), _c(this, t), Gb([
					["start", "startValue"],
					["end", "endValue"]
				], function(t, n) {
				...
				t && Wb(function(e) {
					if (t) {
						...
						if (r.length && !i.length)
							for (var o = 0, a = r.length; o < a; o++) "category" === r[o].get("type") && i.push(o);
		...
		Qb = "horizontal",
		Jb = 5,
		tS = ["line", "bar", "candlestick", "scatter"],
		eS = Ub.extend({
			type: "dataZoom.slider",
			init: function(t, e) {
					...
					return t.eachTargetAxis(function(r, o) {
						d(t.getAxisProxy(r.name, o).getTargetSeriesModels(), function(t) {
							if (!(n || !0 !== e && l(tS, t.get("type")) < 0)) {
								var a, s = i.getComponent(r.axis, o).axis,
									h = Sc(r.name),
			...
			_updateDataInfo: function(t) {
				function e(t) {
					var e = lr(i.handles[t].parent, this.group),
						n = ur(0 === t ? "right" : "left", e),
						s = this._handleWidth / 2 + Jb,
						l = hr([c[t] + (0 === t ? -s : s), this._size[1] / 2], e);
					r[t].setStyle({
						x: l[0],
						y: l[1],
		...
		render: function(t, e, n, i) {
			...
			function o(i, r, o) {
				var l = i.getModel("iconStyle"),
					...
					u = r.getIcons ? r.getIcons() : i.get("icon"),
					c = i.get("title") || {};
				if ("string" == typeof u) {
					var f = u,
						p = c;
	...
	Qc.defaultOption = {
		...
		if (r.href = a, "function" != typeof MouseEvent || Kf.browser.ie || Kf.browser.edge)
	...
	var gS = qy.toolbox.dataView,
		mS = new Array(60).join("-"),
		vS = "\t",
		yS = new RegExp("[" + vS + "]+", "g");
	hd.defaultOption = {
		show: !0,
	...
	var OS = {
			mousedown: function(t) {
				if (this._dragging) Zd.call(this, t);
		...
		RS = l,
		BS = v,
		VS = ["dataToPoint", "pointToData"],
		FS = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"],
		HS = Kd.prototype;
	HS.setOutputRanges = function(t, e) {
		this.matchOutputRanges(t, e, function(t, e, n) {
			if ((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange) {
				...
				t.__rangeOffset = {
					offset: XS[t.brushType](i.values, t.range, [1, 1]),
					xyMinMax: i.xyMinMax
				}
			}
		})
		...
		NS(t, function(t) {
			...
			if (t.range = t.range || [], n && !0 !== n) {
				t.panelId = n.panelId;
				var i = US[t.brushType](0, n.coordSys, t.coordRange),
					r = t.__rangeOffset;
		...
		for (var n = this._targetInfoList, i = Jd(e, t), r = 0; r < n.length; r++) {
			...
			if (a) {
				...
				for (r = 0; r < WS.length; r++)
					if (WS[r](i, o)) return o
		}
		return !0
	};
	var GS = {
		...
		US = {
			...
			lineY: BS(tf, 1),
			rect: function(t, e, n) {
				var i = e[VS[t]]([n[0][0], n[1][0]]),
					r = e[VS[t]]([n[0][1], n[1][1]]),
	...
	var qS = qy.toolbox.dataZoom,
		$S = d,
		KS = "\0_ec_\0toolbox-dataZoom_";
	uf.defaultOption = {
		show: !0,
		icon: {
	...
	QS._onBrush = function(t, e) {
		...
		if (e.isEnd && t.length) {
			var r = {},
				o = this.ecModel;
			this._brushController.updateCovers([]), new Kd(cf(this.model.option), o, {
				include: ["grid"]
			}).matchOutputRanges(t, o, function(t, e, i) {
				if ("cartesian2d" === i.type) {
					var r = t.brushType;
					"rect" === r ? (n("x", i, e[0]), n("y", i, e[1])) : n({
						lineX: "x",
						lineY: "y"
					}[r], i, e)
				}
	...
	var eM, nM = "urn:schemas-microsoft-com:vml",
		iM = "undefined" == typeof window ? null : window,
		rM = !1,
		oM = iM && iM.document;
	...
	if (!Kf.canvasSupported) {
		...
		je.prototype.brushVML = function(t) {
			...
			if (AM(r)) {
				var o = r.src;
				if (o === this._imageSrc) e = this._imageWidth, n = this._imageHeight;
				else {
			...
			if (r) {
				...
				if (this.transform && (x = this.transform, b = lM(x[0] * x[0] + x[1] * x[1]), S = lM(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
					...
					var D = dM(M[0], I[0], T[0], C[0]),
						A = dM(M[1], I[1], T[1], C[1]),
						k = [];
				...
				var O = P.style;
				if (v) {
					if (e && n) O.width = sM(b * e * c / f) + "px", O.height = sM(S * n * d / p) + "px";
					else {
						var z = new Image,
							E = this;
						z.onload = function() {
		...
		! function(t, e) {
			...
			return kM.innerHTML = "", kM.appendChild(n.createTextNode(t)), {
				width: kM.offsetWidth
			}
		});
		for (var EM = new Xt, NM = [Sg, Xe, je, xi, ov], RM = 0; RM < NM.length; RM++) {
			...
			BM.drawRectText = function(t, e, n, i) {
				...
				if (null != o && (o += ""), o) {
					...
					if (v && !i && (EM.copy(e), EM.applyTransform(v), e = EM), i) c = e.x, d = e.y;
					else {
						var y = r.textPosition,
							x = r.textDistance;
						if (y instanceof Array) c = e.x + wM(y[0], e.width), d = e.y + wM(y[1], e.height), f = f || "left";
						else {
							var _ = me(y, e, x);
	...
	var QM = {},
		...
		tI = function(t, e, n) {
			...
			if (null != r) {
				...
				var a, s, l = i.textPosition,
					h = i.textDistance,
					u = i.textAlign || "left";
				"number" == typeof i.fontSize && (i.fontSize += "px");
				var c = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || yg,
					d = kf(i.textVerticalAlign),
					f = (n = ce(r, c, u, d)).lineHeight;
				if (l instanceof Array) a = e.x + l[0], s = e.y + l[1];
				else {
					var p = me(l, e, h);
				...
				var g = i.textPadding;
				if (Tf(o, "x", a), Tf(o, "y", s), Df(o, i, !0), t instanceof ov || t.style.transformText) If(o, t.transform);
				else {
					if (t.transform) JM.copy(e), JM.applyTransform(t.transform), e = JM;
					else {
	...
	zf.prototype.createElement = _f, zf.prototype.getDefs = function(t) {
		...
		if (s.shadowBlur || s.shadowOffsetX || s.shadowOffsetY) i = s.shadowOffsetX || 0, r = s.shadowOffsetY || 0, o = s.shadowBlur, a = s.shadowColor;
		else {
